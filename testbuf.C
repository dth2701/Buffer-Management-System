...
int main()
{
  ...
  struct stat statusBuf;
    ...
    for (i = 0; i < num; i++) {
      ...
      snprintf((char*)page, PAGESIZE, "test.1 Page %d %7.1f", j[i], (float)j[i]);
    ...
    for (i = 0; i < num/3; i++) 
    {
      ...
      snprintf((char*)page, PAGESIZE, "test.2 Page %d %7.1f", j[i], (float)j[i]);

      CALL(bufMgr->allocPage(file3, pageno3, page3));
      // sprintf((char*)page3, "test.3 Page %d %7.1f", pageno3, (float)pageno3);
      snprintf((char*)page, PAGESIZE, "test.3 Page %d %7.1f", j[i], (float)j[i]);
    ...
    for (i = 0; i < num; i++) {
      ...
      snprintf((char*)page, PAGESIZE, "test.4 Page %d %7.1f", j[i], (float)j[i]);
